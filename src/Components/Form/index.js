...
const Form = ({ currentId, setCurrentId }) => {
  ...
  const discount = useSelector((state) =>
    currentId
      ...
      state.coupons?.coupons?.coupons?.find((p) => p._id === currentId)
...
console.log(discountData)
  ...
  useEffect(() => {
    if (discount)
      ...
      setValue(discount?.campaignType)
  }, [discount]);
console.log(value)
        ...
        >
          ...
          <Grid my={5} sm={12}>
            <FormControl
              ...
              style={{ width: "100%" }}
            >
              <InputLabel htmlFor="merchant">Select Merchant</InputLabel>
              <Select
                name="merchant"
                // value={discountData.merchantName}
